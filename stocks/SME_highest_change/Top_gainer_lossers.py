...
# Example usage
input_file = 'SME_STOCKS.csv'  # Replace with the path to your input CSV file
...
pd.DataFrame(top_10_max_change).to_csv('SME_Top_Gainers.csv', index=False)
pd.DataFrame(top_10_min_change).to_csv('SME_Top_Losers.csv', index=False)
